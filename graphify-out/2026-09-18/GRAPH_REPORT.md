...
### Community 2 - ".push"
Cohesion: 0.03
Nodes (55): addChildren(), CaretAnnotation, ChoiceWidgetAnnotation, CircleAnnotation, codePointIter(), computeIDs(), createImage(), createImageDict() (+47 more)
...
### Community 7 - "warn"
Cohesion: 0.03
Nodes (29): AppearanceStreamEvaluator, Catalog, clearGlobalCaches(), CmykICCBasedCS, createDataNode(), createValidAbsoluteUrl(), DatasetReader, decodeString() (+21 more)
...
Cohesion: 0.06
Nodes (68): client_config, FittedInvoice(), InvoiceDialog(), TicketViewer(), ClientDraft, Draft, Draft, PeriodCells() (+60 more)

### Community 17 - ".has"
Cohesion: 0.04
Nodes (25): adjustMapping(), appendIfJavaScriptDict(), addPageDict(), addPageError(), parseNestedOrder(), parseOnOff(), parseOrder(), _collectJS() (+17 more)
...
Cohesion: 0.05
Nodes (68): reviewStops(), downloadCsv(), exportCsv(), batchDate(), batchesByRecency(), batchInvoiceFor(), byDay(), FIRST_INVOICE_NUMBER (+60 more)
...
Cohesion: 0.03
Nodes (43): addCachedImageOps(), assert(), BaseLocalCache, BaseShading, CheckedOperatorList, CMapFactory, ColorSpaceUtils, DummyShading (+35 more)
...
Cohesion: 0.09
Nodes (6): generateFont(), getFamilyName(), getFontSubstitution(), PDFDocument, validateCSSFont(), validateFontName()
...
### Community 41 - "load-desk.tsx"
Cohesion: 0.05
Nodes (85): InvoiceView, COLUMNS, InvoiceLine, InvoiceSheet(), lineLayout(), applyTruck(), buildQueueItem(), defaultInvoice() (+77 more)

### Community 42 - "load-desk-store.ts"
Cohesion: 0.17
Nodes (23): setLogoVersion(), applyRecordEdit(), NewClient, NewCompany, NewCustomer, NewRecord, NewTruck, ProfileKind (+15 more)
...
### Community 54 - ".get"
Cohesion: 0.05
Nodes (12): Annotation, ButtonWidgetAnnotation, collectActions(), FileSpec, getInheritableProperty(), getSoundFormat(), MediaAnnotation, PasswordException (+4 more)
...
Cohesion: 0.13
Nodes (17): parseOperand(), createCmapTable(), createNameTable(), createOS2Table(), createPostscriptName(), createPostTable(), DataBuilder, readTableEntry() (+9 more)
...
Cohesion: 0.09
Nodes (42): editKey(), hasChanges(), clearUnreadableRecords(), confirmDelete(), editSaved(), persistChanges(), saveActive(), saveChanges() (+34 more)
...
Cohesion: 0.21
Nodes (23): amount(), cleanAddresses(), dateOrEmpty(), invoiceKeyOf(), isObject(), MAX_EDITS, nullableText(), optionalId() (+15 more)
...
Cohesion: 0.07
Nodes (51): metadata, AttentionItem, Delta(), HomePage(), tonsText(), blankDraft(), draftFrom(), FleetPage() (+43 more)
...
Cohesion: 0.07
Nodes (9): DocumentData, MurmurHash3_64, parseMarkedContentProps(), _parseVisibilityExpression(), Ref, RefMap, StructElementNode, StructTreePage (+1 more)
...
Cohesion: 0.11
Nodes (8): AnnotationFactory, getVerbosityLevel(), isRefsEqual(), finishWorkerTask(), getPassword(), loadDocument(), startWorkerTask(), WorkerTask
...
### Community 133 - "ticket-extraction.ts"
Cohesion: 0.24
...
### Community 140 - ".parse"
Cohesion: 0.08
Nodes (12): CFF, CFFCharset, CFFDict, CFFFDSelect, CFFHeader, CFFParser, CFFPrivateDict, CFFTopDict (+4 more)
...
Cohesion: 0.09
Nodes (17): Cmd, expectInt(), expectString(), extendCMap(), IdentityCMap, isCmd(), Lexer, parseBfChar() (+9 more)
...
Cohesion: 0.30
Nodes (12): DELETE(), GET(), PUT(), tooLarge(), ORIGINALS_BUCKET, folder(), loadLogo(), LOGO_VERSION (+4 more)
...
Cohesion: 0.11
Nodes (15): adjustWidths(), amendFallbackToUnicode(), applyStandardFontGlyphMap(), buildToFontChar(), es, getLookupTableFactory(), getStandardFontName(), getUnicodeForGlyph() (+7 more)
...
- **Why does `XhtmlNamespace` connect `XhtmlObject` to `pdf.worker.min.mjs`, `TextMeasure`, `.has`, `PsJsCompiler`, `FormatError`, `.getTextContent`?**
...
- **Should `.push` be split into smaller, more focused modules?**
  _Cohesion score 0.03203579418344519 - nodes in this community are weakly interconnected._