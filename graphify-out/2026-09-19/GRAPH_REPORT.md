...
## Corpus Check
- 252 files · ~266,727 words
- Verdict: corpus is large enough that graph structure adds value.
- Unclassified: 33 file(s) not represented in the graph (top: (none) 11, .css 8, .wasm 6)

## Summary
- 7404 nodes · 18477 edges · 210 communities (162 shown, 48 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 494 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `0eee1316`
...
Cohesion: 0.01
Nodes (202): aa, af, Ai, al, amendFallbackToUnicode(), Ao, applyStandardFontGlyphMap(), ar (+194 more)
...
Cohesion: 0.04
Nodes (23): addPageDict(), addPageError(), computeIDs(), DocumentData, escapePDFName(), EvalState, getIndexes(), incrementalUpdate() (+15 more)
...
### Community 7 - ".get"
Cohesion: 0.05
Nodes (27): appendIfJavaScriptDict(), _collectJS(), createValidAbsoluteUrl(), DatasetReader, decodeString(), deepCompare(), fetchDest(), fetchRemoteDest() (+19 more)

### Community 8 - ".success"
Cohesion: 0.05
Nodes (36): applyAssist(), ariaLabel(), Border, Caption, CheckButton, checkDimensions(), ChoiceList, computeBbox() (+28 more)
...
### Community 11 - "Dict"
Cohesion: 0.05
Nodes (29): ChoiceWidgetAnnotation, createImage(), createImageDict(), createPNGLikeImage(), createRawImage(), DefaultAppearanceEvaluator, Dict, ErrorFont (+21 more)
...
### Community 15 - "Stream"
Cohesion: 0.05
Nodes (10): addHex(), BinaryCMapReader, BinaryCMapStream, CMap, createBuiltInCMap(), hexToInt(), hexToStr(), incHex() (+2 more)

### Community 16 - "account-page.tsx"
Cohesion: 0.06
Nodes (90): InvoiceDialog(), InvoiceView, rememberAddress(), rememberSpelling(), addressOf(), blankClient(), ClientDraft, ClientsSection() (+82 more)

### Community 17 - "resolve.ts"
Cohesion: 0.09
Nodes (54): EvidenceSource, ADVISORY_SOURCES, combinedWeight(), CRITICAL_FIELDS, DERIVATION_SOURCES, DERIVED_CONFIDENCE_CAP, EVIDENCE_WEIGHTS, evidenceWeight() (+46 more)
...
Cohesion: 0.03
Nodes (163): FittedInvoice(), applyCustomer(), applyTruck(), buildQueueItem(), clientBillTo(), defaultInvoice(), editKey(), editOf() (+155 more)
...
### Community 23 - "warn"
Cohesion: 0.03
Nodes (41): addCachedImageOps(), adjustWidths(), assert(), CheckedOperatorList, CMapFactory, ColorSpaceUtils, createDataNode(), fetchBinaryData() (+33 more)
...
Cohesion: 0.04
Nodes (15): Color, config_Area, Data, Equate, Fill, getFloat(), getInteger(), getKeyword() (+7 more)
...
Cohesion: 0.05
Nodes (74): AccountPage(), DetailsForm(), save(), LanguagePanel(), choose(), ProfileHero(), savePhoto(), SecurityPanel() (+66 more)
...
Cohesion: 0.04
Nodes (92): metadata, AXIS_TICK, ChartLine, LazyChart, LoadsAreaChart(), LoadsAreaChart(), PointTooltip(), tonsText() (+84 more)
...
Cohesion: 0.04
Nodes (29): Annotation, BaseShading, CaretAnnotation, CircleAnnotation, DummyShading, FileAttachmentAnnotation, FunctionBasedShading, getColorConversionBatchSize() (+21 more)
...
Cohesion: 0.11
Nodes (33): InvoiceAddressForm(), chooseDefault(), save(), InvoiceAddressPanel(), oneLine(), WorkspacePanel(), dropLogo(), saveLogo() (+25 more)

### Community 53 - "format.ts"
Cohesion: 0.10
Nodes (45): COLUMNS, InvoiceLine, InvoiceSheet(), lineLayout(), marked(), saveNewCustomer(), dateRange(), downloadCsv() (+37 more)

### Community 54 - "shadow"
Cohesion: 0.04
Nodes (10): AppearanceStreamEvaluator, Catalog, FeatureTest, InfoUtils, LocalColorSpaceCache, ObjectLoader, Page, PDFFunctionFactory (+2 more)
...
Cohesion: 0.21
Nodes (19): LANGUAGES, PUT(), POST(), DELETE(), GET(), Context, DELETE(), PUT() (+11 more)
...
### Community 64 - "document-scanner.tsx"
Cohesion: 0.12
Nodes (25): blobFrom(), canvas(), DocumentScanner(), capture(), checkFraming(), frame(), startCamera(), stopCamera() (+17 more)
...
### Community 66 - ".push"
Cohesion: 0.08
Nodes (22): addChildren(), ChunkedStreamManager, encodeToXmlString(), EvaluatorPreprocessor, addFakeSpaces(), appendEOL(), applyInverseRotation(), buildTextContentItem() (+14 more)

### Community 67 - "contract.ts"
Cohesion: 0.12
...
Cohesion: 0.05
Nodes (23): app_login_login, metadata, metadata, metadata, metadata, metadata, metadata, client_config (+15 more)
...
### Community 80 - ".has"
Cohesion: 0.06
Nodes (18): adjustMapping(), ButtonWidgetAnnotation, parseNestedOrder(), parseOnOff(), parseOrder(), collectActions(), Commands, compileCharString() (+10 more)
...
Cohesion: 0.07
Nodes (41): ALLOWED_TYPES, extract(), failure(), POST(), read(), readImage(), EdgeState, clean() (+33 more)
...
Cohesion: 0.06
Nodes (9): AnnotationFactory, clearGlobalCaches(), PDFDocument, stringToBytes(), finishWorkerTask(), getPassword(), loadDocument(), startWorkerTask() (+1 more)
...
Cohesion: 0.10
Nodes (10): ObservedField, PaperFrame, RecoveryContext, EvidenceSeed, here, here, SOURCES, STRENGTHS (+2 more)
...
### Community 92 - "logo/route.ts"
Cohesion: 0.16
Nodes (22): DELETE(), GET(), PUT(), tooLarge(), DELETE(), GET(), PUT(), tooLarge() (+14 more)
...
### Community 104 - ".constructor"
Cohesion: 0.15
Nodes (3): CmykICCBasedCS, IccColorSpace, Pattern
...
Cohesion: 0.11
Nodes (34): UNKNOWN_FRAME, clippedAtBottom(), Detection, dimensions(), distance(), expandCorners(), guidance(), movement() (+26 more)
...
Cohesion: 0.18
Nodes (15): blobOf(), canvasOf(), ExtractedPage, PageReading, batchPercent(), clamp(), createFileProgress(), FileProgress (+7 more)
...
### Community 139 - "empty.tsx"
Cohesion: 0.29
Nodes (7): Empty(), EmptyContent(), EmptyDescription(), EmptyHeader(), EmptyMedia(), emptyMediaVariants, EmptyTitle()

### Community 140 - "load-desk-store.ts"
Cohesion: 0.12
Nodes (30): ALLOWED_TYPES, Context, PUT(), setLogoVersion(), CompanyProfile, applyRecordEdit(), MAX_ORIGINAL_BYTES, NewClient (+22 more)
...
### Community 188 - "app-shell.tsx"
Cohesion: 0.09
Nodes (25): app_workspace_account_account, app_workspace_home, app_workspace_load_desk_load_desk, app_workspace_profiles, app_workspace_records_records, AppShell(), SWIPE_PAGES, TabBar() (+17 more)

### Community 189 - "MessageHandler"
Cohesion: 0.20
Nodes (4): MessageHandler, ResponseException, UnknownErrorException, wrapReason()
...
### Community 213 - "recovery-end-to-end.test.ts"
Cohesion: 0.04
Nodes (75): blockedByReview(), saveNewClient(), normalizeName(), recoveryStatus(), ClientProfile, ClippedEdge, FieldResolution, addRelationship() (+67 more)

## Knowledge Gaps
- **557 isolated node(s):** `$schema`, `singleQuote`, `printWidth`, `sortPackageJson`, `ignorePatterns` (+552 more)
...
- **Why does `XhtmlNamespace` connect `XhtmlObject` to `pdf.worker.min.mjs`, `.push`, `PsWasmCompiler`, `warn`?**
...
- **Should `pdf.worker.min.mjs` be split into smaller, more focused modules?**
  _Cohesion score 0.009647169938608919 - nodes in this community are weakly interconnected._
- **Should `ConfigNamespace` be split into smaller, more focused modules?**
  _Cohesion score 0.011398342059336824 - nodes in this community are weakly interconnected._
