...
## Communities (211 total, 48 thin omitted)

### Community 0 - "pdf.worker.min.mjs"
Cohesion: 0.01
Nodes (201): aa, af, Ai, al, amendFallbackToUnicode(), Ao, applyStandardFontGlyphMap(), ar (+193 more)
...
### Community 2 - ".has"
Cohesion: 0.04
Nodes (31): addChildren(), adjustMapping(), addPageDict(), addPageError(), parseNestedOrder(), parseOnOff(), parseOrder(), _collectJS() (+23 more)
...
Cohesion: 0.01
Nodes (55): Assist, BatchOutput, Bind, BindItems, Bookend, Border, Calculate, Certificates (+47 more)

### Community 5 - "profiles.ts"
Cohesion: 0.05
Nodes (77): InvoiceAddressPanel(), rememberAddress(), rememberSpelling(), saveNewClient(), addressOf(), blankClient(), ClientsSection(), confirmDelete() (+69 more)
...
### Community 7 - ".get"
Cohesion: 0.07
Nodes (17): appendIfJavaScriptDict(), createValidAbsoluteUrl(), DatasetReader, decodeString(), FileSpec, getSoundFormat(), isDict(), isName() (+9 more)
...
### Community 11 - ".push"
Cohesion: 0.04
Nodes (40): AnnotationFactory, CaretAnnotation, CircleAnnotation, computeIDs(), createImage(), createImageDict(), Dict, encodeToXmlString() (+32 more)
...
Cohesion: 0.06
Nodes (60): Delta(), FittedInvoice(), InvoiceDialog(), InvoiceView, TicketViewer(), ClientDraft, Draft, PeriodCells() (+52 more)

### Community 17 - "resolve.ts"
Cohesion: 0.06
Nodes (65): EvidenceSource, FieldStatus, ADVISORY_SOURCES, combinedWeight(), CRITICAL_FIELDS, DERIVATION_SOURCES, DERIVED_CONFIDENCE_CAP, EVIDENCE_WEIGHTS (+57 more)
...
Cohesion: 0.07
Nodes (8): addHTML(), Area, createLine(), ExclGroup, flushHTML(), getAvailableSpace(), getContainedChildren(), Subform
...
Cohesion: 0.04
Nodes (36): addCachedImageOps(), adjustWidths(), BaseShading, CheckedOperatorList, CMapFactory, DummyShading, fetchBinaryData(), FunctionBasedShading (+28 more)
...
Cohesion: 0.10
Nodes (42): ClientProfile, CompanyProfile, amount(), cleanAddresses(), cleanLocationRates(), CLIPPED_EDGES, dateOrEmpty(), EDGE_STATES (+34 more)
...
Cohesion: 0.05
Nodes (60): metadata, AccountPage(), DetailsForm(), save(), ProfileHero(), savePhoto(), SecurityPanel(), leave() (+52 more)
...
Cohesion: 0.05
Nodes (80): metadata, AXIS_TICK, ChartLine, LazyChart, LoadsAreaChart(), LoadsAreaChart(), PointTooltip(), tonsText() (+72 more)

### Community 42 - "warn"
Cohesion: 0.04
Nodes (35): bytesToString(), createDataNode(), EvaluatorPreprocessor, expectInt(), expectString(), extendCMap(), sanitizeTTProgram(), FormatError (+27 more)
...
Cohesion: 0.13
Nodes (25): InvoiceAddressForm(), chooseDefault(), save(), oneLine(), WorkspacePanel(), dropLogo(), saveLogo(), saveName() (+17 more)

### Community 53 - "format.ts"
Cohesion: 0.11
Nodes (41): COLUMNS, InvoiceLine, InvoiceSheet(), lineLayout(), marked(), downloadLedger(), billToFit(), csvCell() (+33 more)

### Community 54 - "shadow"
Cohesion: 0.04
Nodes (8): AppearanceStreamEvaluator, Catalog, FeatureTest, LocalColorSpaceCache, ObjectLoader, Page, PDFFunctionFactory, shadow()
...
### Community 62 - ".parse"
Cohesion: 0.12
Nodes (6): CFFDict, CFFFDSelect, CFFParser, parseOperand(), CFFTopDict, parseIndex()
...
### Community 67 - "WidgetAnnotation"
Cohesion: 0.07
Nodes (11): ButtonWidgetAnnotation, ChoiceWidgetAnnotation, collectActions(), DefaultAppearanceEvaluator, ErrorFont, escapeString(), getInheritableProperty(), parseDefaultAppearance() (+3 more)
...
Cohesion: 0.21
Nodes (7): decrypt(), findBlock(), isHexDigit(), isSpecial(), isWhiteSpace(), Type1CharString, Type1Parser

### Community 71 - "storage.ts"
Cohesion: 0.10
Nodes (38): clearUnreadableRecords(), editSaved(), confirmDelete(), dataMode, datedFromTicket(), staleInvoiceDates(), LIVE_INTERVAL_MS, watchForChanges() (+30 more)
...
### Community 77 - "Stream"
Cohesion: 0.05
Nodes (12): CmykICCBasedCS, ColorSpaceUtils, escapePDFName(), fetchSync(), IccColorSpace, IndexedCS, MathClamp(), NullStream (+4 more)
...
### Community 80 - ".add"
Cohesion: 0.05
Nodes (18): Commands, compileCharString(), bezierCurveTo(), lineTo(), moveTo(), CompiledFont, compileGlyf(), lineTo() (+10 more)

### Community 81 - "auth.ts"
Cohesion: 0.10
Nodes (35): POST(), POST(), GET(), POST(), redirect(), app_workspace_account_account, app_workspace_home, WorkspaceLayout() (+27 more)
...
Cohesion: 0.09
Nodes (4): PDFDocument, stringToBytes(), utf8PasswordToBytes(), utf8StringToString()
...
Cohesion: 0.07
Nodes (4): clearGlobalCaches(), PageData, PDFEditor, Ref
...
Cohesion: 0.06
Nodes (22): AES128Cipher, AES256Cipher, AESBaseCipher, ARCFourCipher, calculateMD5(), calculateSHA384(), calculateSHA512(), ch() (+14 more)
...
### Community 112 - ".wrap"
Cohesion: 0.10
Nodes (6): CFF, CFFCharset, CFFHeader, CFFPrivateDict, CFFStrings, Type1Font

### Community 113 - "Jbig2Stream"
Cohesion: 0.11
Nodes (4): CCITTFaxStream, Jbig2Stream, JpxError, JpxImage

### Community 114 - "geometry.ts"
Cohesion: 0.11
Nodes (35): PaperFrame, UNKNOWN_FRAME, clippedAtBottom(), Detection, dimensions(), distance(), expandCorners(), guidance() (+27 more)
...
Cohesion: 0.11
Nodes (14): getNewAnnotationsMap(), LocalPdfManager, makeArr(), NetworkPdfManager, ensureNotTerminated(), finishWorkerTask(), getPassword(), loadDocument() (+6 more)
...
### Community 123 - "Font"
Cohesion: 0.14
Nodes (7): compileFontInfo(), convertCidString(), Font, fonts_Glyph, getSubroutineBias(), ka, wa
...
Cohesion: 0.09
Nodes (9): assert(), BasePDFStream, MessageHandler, PDFWorkerStream, PDFWorkerStreamRangeReader, PDFWorkerStreamReader, toRomanNumerals(), WorkerMessageHandler (+1 more)

### Community 138 - "PDFImage"
Cohesion: 0.13
Nodes (4): convertBlackAndWhiteToRGBA(), convertToRGBA(), ImageResizer, PDFImage

### Community 139 - "extract/route.ts"
Cohesion: 0.21
...
Cohesion: 0.10
Nodes (41): ALLOWED_TYPES, Context, GET(), PUT(), DELETE(), GET(), PUT(), setLogoVersion() (+33 more)

### Community 142 - "recovery-queue.test.ts"
Cohesion: 0.19
Nodes (12): acceptableValue(), canLeaveEmpty(), reviewState(), clipped(), complete, frame(), hauled(), noProfiles (+4 more)
...
### Community 171 - "What You Must Do When Invoked"
Cohesion: 0.20
...
Cohesion: 0.05
Nodes (76): ClippedEdge, Evidence, FieldResolution, ObservedField, ObservedTicket, TicketRecovery, addRelationship(), addValue() (+68 more)
...
- **Why does `XhtmlNamespace` connect `XhtmlObject` to `pdf.worker.min.mjs`, `.getTextContent`, `PsWasmCompiler`, `.createDocumentHandler`, `PDFEditor`?**
...
- **Should `pdf.worker.min.mjs` be split into smaller, more focused modules?**
  _Cohesion score 0.009948737421682173 - nodes in this community are weakly interconnected._
...
- **Should `.has` be split into smaller, more focused modules?**
  _Cohesion score 0.04113475177304964 - nodes in this community are weakly interconnected._