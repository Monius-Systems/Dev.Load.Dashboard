...
Cohesion: 0.01
Nodes (200): a, aa, adjustWidths(), af, Ai, al, Ao, applyStandardFontGlyphMap() (+192 more)
...
### Community 2 - ".get"
Cohesion: 0.04
Nodes (31): appendIfJavaScriptDict(), addPageDict(), parseNestedOrder(), parseOnOff(), parseOrder(), collectActions(), _collectJS(), DocumentData (+23 more)

### Community 3 - "PsWasmCompiler"
Cohesion: 0.05
Nodes (25): ast_Parser, buildPostScriptWasmFunction(), encodeASCIIString(), lexer_Lexer, Li, _nodesEqual(), parsePostScriptFunction(), PsArgNode (+17 more)
...
Cohesion: 0.06
Nodes (47): rememberAddress(), rememberSpelling(), draftFrom(), customerAddresses(), customerLocationRates(), LocationRate, locationRateFor(), normalizeAddress() (+39 more)
...
Cohesion: 0.09
Nodes (4): Annotation, LinkAnnotation, PopupAnnotation, nodeToSerializable()

### Community 8 - ".success"
Cohesion: 0.05
Nodes (39): Step 2 - Detect files, Step 2 - Detect files, applyAssist(), ariaLabel(), Caption, CheckButton, checkDimensions(), ChoiceList (+31 more)
...
### Community 11 - ".push"
Cohesion: 0.03
Nodes (53): CaretAnnotation, ChoiceWidgetAnnotation, CircleAnnotation, codePointIter(), createImage(), createImageDict(), createPNGLikeImage(), createRawImage() (+45 more)
...
Cohesion: 0.08
Nodes (60): LoadsAreaChart(), FittedInvoice(), InvoiceDialog(), InvoiceView, SourcePreview(), TicketViewer(), ClientDraft, CustomerLoadsChart() (+52 more)

### Community 17 - "resolve.ts"
Cohesion: 0.04
Nodes (111): blockedByReview(), recoveryStatus(), ClippedEdge, EdgeState, Evidence, EvidenceSource, FieldResolution, FieldStatus (+103 more)
...
Cohesion: 0.04
Nodes (108): metadata, applyCustomer(), applyTruck(), buildQueueItem(), clientBillTo(), defaultInvoice(), editKey(), editOf() (+100 more)
...
Cohesion: 0.04
Nodes (33): addCachedImageOps(), amendFallbackToUnicode(), CFFFont, CheckedOperatorList, EvalState, fetchBinaryData(), generateFont(), getEncoding() (+25 more)
...
### Community 27 - "loads-area-chart.tsx"
Cohesion: 0.25
Nodes (9): AXIS_TICK, ChartLine, LazyChart, LoadsAreaChart(), PointTooltip(), tonsText(), SeriesPoint, ref_next_dynamic (+1 more)
...
Cohesion: 0.02
Nodes (31): Acrobat, Agent, BatchOutput, Color, Common, Compress, Config, config_Area (+23 more)
...
Cohesion: 0.05
Nodes (63): AccountPage(), DetailsForm(), save(), ProfileHero(), savePhoto(), SecurityPanel(), leave(), submit() (+55 more)
...
Cohesion: 0.06
Nodes (59): metadata, AttentionItem, Delta(), HomePage(), tonsText(), barPath(), FULL_MONTHS, LoadsChart() (+51 more)

### Community 42 - "FormatError"
Cohesion: 0.03
Nodes (39): an, bytesToString(), parseOperand(), CipherTransform, convertCidString(), DatasetReader, decodeString(), EvaluatorPreprocessor (+31 more)
...
### Community 44 - "MathClamp"
Cohesion: 0.04
Nodes (16): BaseShading, Commands, DefaultAppearanceEvaluator, DummyShading, FunctionBasedShading, getColorConversionBatchSize(), IccColorSpace, IndexedCS (+8 more)

### Community 45 - "cn"
Cohesion: 0.02
Nodes (131): SWIPE_PAGES, AlertDialogMedia(), AlertDialogOverlay(), Avatar(), AvatarBadge(), AvatarFallback(), AvatarGroup(), AvatarGroupCount() (+123 more)
...
Cohesion: 0.10
Nodes (45): COLUMNS, InvoiceLine, InvoiceSheet(), lineLayout(), marked(), dateRange(), downloadCsv(), RecordsPage() (+37 more)

### Community 54 - "warn"
Cohesion: 0.04
Nodes (16): adjustMapping(), AppearanceStreamEvaluator, Catalog, addPageError(), CmykICCBasedCS, createDataNode(), FeatureTest, fetchDest() (+8 more)
...
Cohesion: 0.10
Nodes (7): Ascii85Stream, AsciiHexStream, DecodeStream, DecryptStream, LZWStream, PredictorStream, RunLengthStream
...
### Community 62 - ".add"
Cohesion: 0.05
Nodes (24): assert(), CFF, CFFCharset, CFFDict, CFFFDSelect, CFFHeader, CFFParser, CFFPrivateDict (+16 more)
...
### Community 67 - ".getOperatorList"
Cohesion: 0.09
Nodes (4): ButtonWidgetAnnotation, getInheritableProperty(), getTransformMatrix(), OperatorList
...
Cohesion: 0.09
Nodes (37): batchesByRecency(), byDay(), byTicketDate(), FIRST_INVOICE_NUMBER, groupByTicketDate(), INVOICE_COLUMNS, invoiceGroups(), invoiceKey() (+29 more)
...
Cohesion: 0.07
Nodes (48): blobOf(), canvasOf(), ExtractedPage, extractPages(), PageReading, batchPercent(), clamp(), createFileProgress() (+40 more)
...
Cohesion: 0.14
Nodes (9): arrayBuffersToBytes(), BasePDFStream, NetworkPdfManager, PDFWorkerStream, ensureNotTerminated(), setupDoc(), onFailure(), onSuccess() (+1 more)

### Community 89 - ".preEvaluateFont"
Cohesion: 0.19
Nodes (4): getNewAnnotationsMap(), isArrayEqual(), makeArr(), MurmurHash3_64
...
Cohesion: 0.12
Nodes (18): computeIDs(), DataHandler, addFakeSpaces(), appendEOL(), applyInverseRotation(), buildTextContentItem(), closePendingMarkedContentItems(), compareWithLastPosition() (+10 more)
...
### Community 106 - ".#sn"
Cohesion: 0.24
Nodes (4): AES256Cipher, PDF17, PDF20, PDFBase

### Community 107 - "O"
Cohesion: 0.11
Nodes (4): bi(), O(), pi(), si()

### Community 108 - "parseCMap"
Cohesion: 0.12
Nodes (15): BinaryCMapReader, createBuiltInCMap(), expectInt(), expectString(), extendCMap(), IdentityCMap, parseBfChar(), parseBfRange() (+7 more)
...
Cohesion: 0.05
Nodes (11): AbortException, AnnotationFactory, clearGlobalCaches(), deepCompare(), isRefsEqual(), PDFDocument, finishWorkerTask(), getPassword() (+3 more)
...
### Community 123 - "extract/route.ts"
Cohesion: 0.23
...
Cohesion: 0.10
Nodes (7): BasePDFStreamRangeReader, MessageHandler, PDFWorkerStreamRangeReader, ResponseException, UnknownErrorException, WorkerMessageHandler, wrapReason()

### Community 138 - "ImageResizer"
Cohesion: 0.23
Nodes (3): convertBlackAndWhiteToRGBA(), convertToRGBA(), ImageResizer

### Community 139 - ".process"
Cohesion: 0.23
Nodes (5): addHex(), BinaryCMapStream, hexToInt(), hexToStr(), incHex()
...
### Community 142 - ".decode"
Cohesion: 0.18
Nodes (3): CCITTFaxStream, JpxError, JpxImage

### Community 143 - "ChunkedStreamManager"
Cohesion: 0.16
Nodes (4): addChildren(), ChunkedStreamManager, ObjectLoader, StreamsSequenceStream
...
### Community 188 - "stringToBytes"
Cohesion: 0.29
Nodes (3): PasswordException, stringToBytes(), utf8PasswordToBytes()

### Community 189 - "phone.ts"
Cohesion: 0.62
Nodes (5): digitsOf(), phoneDisplay(), phoneEdit(), phoneInput(), tenDigits()

### Community 195 - "BrotliStream"
Cohesion: 0.33
...
Cohesion: 0.08
Nodes (35): saveNewClient(), normalizeName(), addRelationship(), addValue(), BATCH_FIELDS, batchEvidence(), buildMemory(), collector() (+27 more)
...
- **Why does `XhtmlNamespace` connect `XhtmlObject` to `pdf.worker.min.mjs`, `.get`, `PsWasmCompiler`, `.getTextContent`, `TextMeasure`, `Br`?**
...
- **Should `pdf.worker.min.mjs` be split into smaller, more focused modules?**
  _Cohesion score 0.009872792861211316 - nodes in this community are weakly interconnected._
- **Should `ConfigNamespace` be split into smaller, more focused modules?**
  _Cohesion score 0.012214342001576044 - nodes in this community are weakly interconnected._
- **Should `.get` be split into smaller, more focused modules?**
  _Cohesion score 0.03565720584182971 - nodes in this community are weakly interconnected._